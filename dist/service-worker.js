...
var staticAssets = ['./index.js', './index.html', './portfolio.js', './manifest.webmanifest', './src/*/*.js'];
...
self.addEventListener('install', function (e) {
  ...
  e.waitUntil(caches.open('noteworthy-cache').then(function (cache) {
