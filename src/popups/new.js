...
const newAlert = new Mosaic({
    ...
    toggle() { this.data.type = this.data.type === 'Notebook' ? 'Note' : 'Notebook'; },
    async create() {
    ...
    view: self => html`<div class='popup-backdrop'>
        <div class='popup'>
            <button class='close-btn' onclick='${self.close.bind(self)}'>
            ...
            <div class="buttons-area">
                <button class='rect-btn hollow-btn' onclick='${self.toggle}'>
                    Switch to ${ self.data.type === 'Notebook' ? 'Note' : 'Notebook' }
                </button>
                &nbsp;
                <button class='rect-btn' onclick='${self.create}'>Create ${ self.data.type }</button>
            </div>
            <br><br>
        </div>
    </div>`
