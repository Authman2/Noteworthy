...
export default new Mosaic({
    ...
    view() {
        ...
        <section class='toolbar-buttons'>
            ...
            <dropdown-button icon='add' highlightColor='lightseagreen'>New</dropdown-button>
            <round-button icon='save' highlightColor='#7C73FF'>Save</round-button>
            <round-button icon='ios-share' highlightColor='#c9700a'>Share</round-button>
            <round-button icon='heart' highlightColor='#FF729E'>Favorite</round-button>
            <round-button icon='move' highlightColor='#0F9CF9'>Move</round-button>
            <dropdown-button icon='search' highlightColor='#2abd56'>Find</dropdown-button>
            <dropdown-button icon='information' highlightColor='#ba2d2d'>Font</dropdown-button>
            <dropdown-button icon='settings' highlightColor='#A7A7A7'>Settings</dropdown-button>
        </section>
        `
    }
})