...
export default new Mosaic({
    ...
    view() {
        ...
        <section class='toolbar-buttons'>
            ...
            <dropdown-button id='new-dropdown' icon='add' highlightColor='lightseagreen' popup='create-popup'>
                New
            </dropdown-button>
            <round-button icon='save' highlightColor='#7C73FF' onclick="${this.handleSave}">
                Save
            </round-button>
